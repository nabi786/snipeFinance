...
import formIcon from 'assets/edit-calendar-interface-symbol2.png';
const lockIcon = 'https://res.cloudinary.com/learn2code/image/upload/v1668853283/lock_mg3mkf.png';
import snipeToolIcon from 'assets/crank-arm.png';

import { Category2, Send2, Lock1, BinanceCoin } from 'iconsax-react';
...
export const sidebarNavigation: SidebarNavigationItem[] = [
  ...
  // },
  {
    title: 'SNIPE  Bulk Transfers',
    key: 'SNIPEBulkTransfers',
    url: '/snipe-bulk-transfers',
    icon: <Send2 variant="Bulk" />,
  },
  {
    title: 'Snipe Lock',
    key: 'lock',
    icon: <Lock1 variant="Bulk" />,
    children: [
      {
        title: 'Create Lock',
        key: 'create lock',
